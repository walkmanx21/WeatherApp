...
public class LocationServiceIT {
    ...
    void whenFindLocationByNameMoscowThenReturn2Locations() {
        ...
        Assertions.assertEquals(6, foundLocationDtoList.size());
    ...
    @Test
    void whenRequestToGetWeatherDataForMoscowThenReturnDataAboutMoscow() {
        Mockito.doReturn(new WeatherResponseDto(
                237, "Moscow", "RU", new BigDecimal("55.7504461"), new BigDecimal("37.6174943"),
